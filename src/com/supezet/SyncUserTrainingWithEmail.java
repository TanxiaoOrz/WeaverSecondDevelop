...
public class SyncUserTrainingWithEmail extends BaseCronJob implements VersionControl {
    ...
    public static void main(String[] args) {
        System.out.println("select h.id,h.workcode,h.lastname,d.departmentcode,h.departmentid from" +
    ...
    private int getAddPeople() {
        final String sql = "SELECT\n" +
                ...
                "\tFROM\n" +
                "\t\tHrmResource AS hrm\n" +
                "\t\tLEFT JOIN uf_transLogin AS LOGIN ON hrm.ID = LOGIN.ry \n" +
                "\tWHERE\n" +
                "\t\try IS NULL \n" +
                "\t\tAND status NOT IN ( 4, 5 ) \n" +
                "\t) AS h\n" +
                "\tLEFT JOIN hrmdepartment AS d ON h.departmentid = d.ID";
...
//        String onBoarding;
        ...
        public User(String employeeCode, String lastname, String organizeCode, String accountStatus, String email) {
