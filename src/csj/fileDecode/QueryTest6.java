...
public class QueryTest6 extends BaseCronJob {
    ...
    public String idsQuerySql =
            ...
            "\t\t\tkm_review_template \n" +
            "\t\tWHERE\n" +
            "\t\tfd_name IN ( '党委印章使用审批表', '工会发文', '工会经审发文', '纪委发文', '纪委收文', '党委收文', '工会收文', '下属企业呈报文件（党委）' )) ";
...
//        Console.log("Mission Finish");
    ...
    static class FileBefore {
        ...
        public String getFileName(int index) {
            ...
            return name+"(" + index +")" + "_" + fd_model_id + "." + split[split.length-1];
        }
