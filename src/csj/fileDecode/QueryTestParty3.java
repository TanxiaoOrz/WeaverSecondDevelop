...
public class QueryTestParty3 extends BaseCronJob {
    ...
    public String idsQuerySql =
            ...
            "\tkm_review_main \n" +
            "WHERE\n" +
            "\tfd_template_id IN ( SELECT fd_id FROM km_review_template WHERE fd_name IN ( '党委印章使用审批表' ) ) \n" +
            ...
            "WHERE\n" +
            "\tfd_template_id IN ( SELECT fd_id FROM km_imissive_signtemp WHERE fd_name IN ( '下属企业呈报文件（党委）', '工会签报', '党委签报', '（党委）会议纪要' ) ) \n" +
            "\tAND doc_create_time < '2024-08-01' \n" +
            "\tAND auth_area_id = '179936464b7019e946d2f9241b585781' UNION\n" +
            "SELECT\n" +
            "\tfd_id  \n" +
            ...
            "WHERE\n" +
            "\tfd_template_id IN ( SELECT fd_id FROM km_imissive_rectemp WHERE fd_name IN ( '纪委收文', '党委收文', '工会收文' ) ) \n" +
            "\tAND doc_create_time < '2024-08-01' \n" +
            "\tAND auth_area_id = '179936464b7019e946d2f9241b585781' UNION\n" +
            "SELECT\n" +
            "\tfd_id  \n" +
            ...
            "WHERE\n" +
            "\tfd_template_id IN ( SELECT fd_id FROM km_imissive_sendtemp WHERE fd_name IN ( '工会发文', '工会经审发文', '纪委发文' ) ) \n" +
            "\tAND doc_create_time < '2024-08-01' \n" +
