 ...
 * @Version: 1.0
 */
public class LostFileDecode extends BaseCronJob {

    public static final String BASIC_DEC_PATH = "/home/resource";
    public static final String BASIC_NEW_PATH = "/home/new";

    public static String typePath = "/Lost/";

    public List<String> fd_ids = new ArrayList<>(3458);
    ...
    private List<FileBefore> initialFromIds() {
        ...
        String execute = "select m.fd_model_id,m.fd_file_name,m.fd_id as fd_id,f.fd_file_path from SYS_ATT_MAIN m left join sys_att_file f on m.fd_file_id = f.fd_id where m.fd_id in (select fd_id from lost)\n";
