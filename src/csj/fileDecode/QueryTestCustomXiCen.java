...
public class QueryTestCustomXiCen extends BaseCronJob {
    ...
    public String idsQuerySql =
            ...
            "\tkm_review_main \n" +
            "WHERE\n" +
            "\tfd_template_id IN ( SELECT fd_id FROM km_review_template WHERE fd_name IN ('合同（协议）会签审核单【西岑】', '西岑印章使用审批表') ) \n" +
            ...
            "WHERE\n" +
            "\tfd_template_id IN ( SELECT fd_id FROM km_imissive_signtemp WHERE fd_name IN ( '西岑签报' ) ) \n" +
            "\tAND doc_create_time < '2024-08-01' \n" +
