...
public class QueryTestAdministration extends BaseCronJob {
    ...
    public String idsQuerySql =
            "SELECT\n" +
                    ...
                    "WHERE\n" +
                    "\tfd_template_id IN ( SELECT fd_id FROM km_imissive_signtemp WHERE fd_name IN ( '新闻公告发布' ) ) \n" +
                    "\tAND doc_create_time < '2024-08-01' \n" +
                    "\tAND auth_area_id = '179936464b7019e946d2f9241b585781' UNION\n" +
                    "SELECT\n" +
                    "\tfd_id \n" +
                    ...
                    "WHERE\n" +
                    "\tfd_template_id IN ( SELECT fd_id FROM km_imissive_sendtemp WHERE fd_name IN ( '安委会发文', '人事发文', '办公室发文' ) ) \n" +
                    "\tAND doc_create_time < '2024-08-01' \n" +
...
//        Console.log("fileBefores=>\n"+fileBefores);
    ...
    public QueryTestAdministration() {
    }
